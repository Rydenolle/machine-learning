 ...
 */
#include <cstdlib> // For random numbers via std::rand.
#include <ctime>   // For std::time, which provides the current time (for our random seed).
#include <iostream>
#include <vector>
...
void initRandom() noexcept
{
    ...
    // std::time(nullptr) provides the current time.
